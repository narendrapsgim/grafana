...
require (
	...
	google.golang.org/api v0.239.0 // @grafana/backend-platform
...
require (
	...
	github.com/googleapis/gax-go/v2 v2.14.2 // @grafana/backend-platform
	...
	google.golang.org/genproto v0.0.0-20250505200425-f936aa4a68b2 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.21.2 // @grafana/backend-platform
