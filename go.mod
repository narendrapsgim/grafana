...
require (
	...
	google.golang.org/api v0.209.0 // @grafana/backend-platform
...
require (
	...
	google.golang.org/genproto v0.0.0-20241113202542-65e8d215514f // indirect; @grafana/backend-platform
)
